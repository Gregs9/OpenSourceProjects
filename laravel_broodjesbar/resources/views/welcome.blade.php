...
<body>
    ...
    <div class="wrapper">
        ...
        <h2 class="subtitel">Nu met Laravel</h2>
        <img id="laravel" src="../../laravel.png">

        @if(session()->has('message'))
            <p style="color: red;" id="feedback">{{session('message')}}</p>
        @endif
        @if(session()->has('success'))
        <p style="color: green;" id="feedback">{{session('success')}}</p>
        @endif
        ...
        <form method="post" id="register" action="{{ route('register') }}">
            ...
            <input type="email" id="reg_email" name="email" placeholder="Je email.." required maxlength="50">
