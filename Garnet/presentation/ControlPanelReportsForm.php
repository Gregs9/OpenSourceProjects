        ...
        <?php if (count($reportSvc->getReports()) > 0) { ?>
            <div id="container-report-info" class="table-container">
                <table id="table-report-info">
                    ...
                    <tbody>
                        <?php foreach ($reportSvc->getReports() as $report) { ?>
                            <tr>
                                <td><?= $report->getReportId() ?></td>
                                <td> <a title="Edit this video in the video editor." class="regular-link"
                                        href="edit-video.php?id=<?= $report->getVideoId() ?>"><?= $report->getVideoId() ?></a>
                                </td>
