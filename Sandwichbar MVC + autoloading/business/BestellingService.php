...
class BestellingService
{
    ...
    public function getBestellingStatusAction(Bestelling $bestelling)
    {
        $string_status = 'Afgewerkt';
        
        if ($bestelling->getStatus() === 'besteld') {
            $string_status = 'Besteld <a href="overzicht.php?afwerk_id=' . $bestelling->getId() . '">(Afwerken)</a>';
        }
