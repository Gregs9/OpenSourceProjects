...
<body>
    ...
    <div class="wrapper">
        <h2>Welkom,
            <?php echo ucfirst(unserialize($_COOKIE['user'], ['User'])->getUsername()) . ' ' ?><a href="inloggen.php?action=loguit">Uitloggen</a>
        </h2>
        <p id="feedback"></p>
            ...
            <table id="besteldeBroodjes">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>' . $bestelSvc->getBestellingStatusAction($bestelling) . '</td>
                    </tr>
                    ';
